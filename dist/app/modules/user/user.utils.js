...
const findLastStudentId = () => __awaiter(void 0, void 0, void 0, function* () {
    const lastStudent = yield model_user_1.User.findOne({
        role: 'student',
    }, {
        id: 1,
        _id: 0,
...
const generateStudentId = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // 2030 01 0001
    const lastStudentSemesterYear = lastStudentId === null || lastStudentId === void 0 ? void 0 : lastStudentId.substring(0, 4); // 2030
...
const findLastFacultyId = () => __awaiter(void 0, void 0, void 0, function* () {
    const lastFaculty = yield model_user_1.User.findOne({
        role: 'faculty',
    }, {
        id: 1,
        _id: 0,
...
const findLastAdminId = () => __awaiter(void 0, void 0, void 0, function* () {
    const lastAdmin = yield model_user_1.User.findOne({
        role: 'admin',
    }, {
        id: 1,
        _id: 0,
