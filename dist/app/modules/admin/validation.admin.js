...
exports.createAdminValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        admin: zod_1.z.object({
            ...
            gender: zod_1.z.enum([...constant_admin_1.Gender]),
            dateOfBirth: zod_1.z.string().optional(),
            email: zod_1.z.string().email(),
            contactNo: zod_1.z.string(),
            emergencyContactNo: zod_1.z.string(),
            bloodGroup: zod_1.z.enum([...constant_admin_1.BloodGroup]),
...
const updateUserNameValidationSchema = zod_1.z.object({
    ...
    middleName: zod_1.z.string().min(1).max(20).optional(),
...
exports.updateAdminValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        admin: zod_1.z.object({
            ...
            gender: zod_1.z.enum([...constant_admin_1.Gender]).optional(),
            dateOfBirth: zod_1.z.string().optional(),
            email: zod_1.z.string().email().optional(),
            contactNo: zod_1.z.string().optional(),
            emergencyContactNo: zod_1.z.string().optional(),
            bloodGroup: zod_1.z.enum([...constant_admin_1.BloodGroup]).optional(),
