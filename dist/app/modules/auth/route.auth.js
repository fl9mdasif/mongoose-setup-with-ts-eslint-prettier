...
router.post('/refresh-token', (0, auth_1.default)('admin'), (0, validateRequest_1.default)(validation_auth_1.authValidation.refreshTokenValidationSchema), controller_auth_1.AuthControllers.refreshToken);
// forget-password
